...
<body>
    <div class="container my-5">
        <h2 class="text-center fw-bold mb-4">Produk Gaming</h2>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                    <div class="card mb-4 product-wap rounded-0 shadow-sm">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li>
                                        <a class="btn btn-success text-white mt-2"
                                           href="{{ route('gaming.show', $produks->id) }}"
                                           title="Lihat Detail">
                        ...
                        <div class="card-body text-center">
                            <a href="{{ route('gaming.show', $produks->id) }}"
                               class="h5 text-decoration-none text-dark fw-bold">
                                {{ $produks->brand }} &ndash; {{ $produks->nama_produk }}
                            </a>
                        </div>
                    </div>
                </div>
