...
<head>
    ...
    <title>Rekap Laporan Service</title>
    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header text-center text-white"
                ...
                <h4><i class="fas fa-file-alt me-2"></i>Rekap Laporan Service</h4>
            </div>
            <div class="card-body">
                ...
                <form method="GET" class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="nama" class="form-control" placeholder="Cari Nama Pelanggan"
                            value="{{ request('nama') }}">
                    </div>
                    <div class="col-md-4">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-search me-2"></i>Cari</button>
                        <a href="{{ route('service.rekap') }}" class="btn btn-danger"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('service.edit', $service->id) }}" class="btn btn-success btn-sm me-2">
                                        <i class="fas fa-tools"></i> Perbaiki
                                    </a>
                ...
                <div class="mt-3">
                    <h5>Ringkasan:</h5>
                    <ul>
                        <li>Total Pengajuan: <strong>{{ $services->count() }}</strong></li>
                    </ul>
                </div>
            </div>
        </div>
