            ...
            <div class="container">
              ...
              <button type="submit" class="btn btn-primary">Search</button>
                        ...
                        <div class="row gy-4" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="stats-item text-center w-100 h-100">
                                    <span data-purecounter-start="0" data-purecounter-end="{{ $jumlahProduk }}"
                                        data-purecounter-duration="1" class="purecounter">{{ $jumlahProduk }}</span>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="card">
                                ...
                                <h3><a href="https://wa.me/6285609336061?text=Halo,%20saya%20ingin%20service%20handphone"
                                        target="_blank" class="stretched-link">Service</a></h3>
                                <p> Perbaikan dan perawatan perangkat IT dengan profesional, memastikan perangkat Anda
                                    selalu
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="card">
                                ...
                                <h3><a href="/layanan" class="stretched-link">sewa HP</a></h3>
                                <p>Harga kompetitif, pilihan produk luas, dan fleksibilitas durasi sewa, memungkinkan Anda
                                    untuk
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                            <div class="card">
                                ...
                                <h3><a href="https://wa.me/6285609336061?text=Halo,%20saya%20ingin%20konsultasi%20mengenai%20layanan%20sewa%20perangkat"
                                        target="_blank" class="stretched-link">Konsultasi</a></h3>
                                <p>Membantu memilih perangkat yang sesuai kebutuhan, memberikan rekomendasi produk yang
                                    tepat
                            ...
                            <div class="card d-flex flex-column justify-content-between h-100 p-3">
                                ...
                                <div class="mt-auto text-end">
                                    <a href="#" class="btn btn-primary"
                                        style="width: 40%; color:white;">Selengkapnya...</a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                            <div class="card d-flex flex-column justify-content-between h-100 p-3">
                                <div>
                                    ...
                                    <p>
                                        Sewa iPhone dari MetroRentalSewa iPhone dengan harga kompetitif dan fleksibilitas
                                        durasi
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                            <div class="card d-flex flex-column justify-content-between h-100 p-3">
                                ...
                                <p>Sewa Smartphone Gaming dari MetroRental
                                    ...
                                    Sewa smartphone gaming dengan harga kompetitif dan fleksibilitas durasi sewa. Tersedia
                                    model
                                    seperti:
                                    ...
                                    Dengan dukungan teknis profesional dan harga terjangkau. Cocok untuk gaming, editing,
                                    dan
